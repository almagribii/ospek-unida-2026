...
export default function Hero() {
	...
	return (
		<section
			ref={sectionRef}
			className="h-screen bg-[linear-gradient(rgba(0,0,0,0.2),rgba(255,255,255,1)),url('/background/white_texture.webp')] bg-cover bg-center flex flex-col justify-center items-center gap-2"
		>
