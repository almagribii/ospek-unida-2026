			...
			{members.map((member) => (
				...
				>
					<div className="relative flex flex-col">
						<div className="absolute -inset-0.5 bg-linear-to-r from-blue-500/60 via-purple-500/60 to-pink-500/60 rounded-3xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
						...
						<div className="relative overflow-hidden rounded-2xl bg-white backdrop-blur-xl border border-gray-200/50 shadow-lg hover:shadow-[0_20px_60px_rgba(59,130,246,0.3)] group-hover:border-linear-to-r group-hover:from-blue-500/60 group-hover:via-purple-500/60 group-hover:to-pink-500/60 transition-all duration-500 group">
							<div className="absolute -top-20 -right-20 w-48 h-48 bg-linear-to-br from-blue-400/0 to-purple-400/0 rounded-full blur-3xl group-hover:from-blue-500/40 group-hover:to-purple-500/40 transition-all duration-500" />
							<div className="absolute -bottom-20 -left-20 w-48 h-48 bg-linear-to-tr from-pink-400/0 to-purple-400/0 rounded-full blur-3xl group-hover:from-pink-500/40 group-hover:to-purple-500/40 transition-all duration-500" />

							<div className="relative w-65 sm:w-70 md:w-80 lg:w-90 aspect-square overflow-hidden bg-gray-100">
								<Image
									src={member.image}
									alt={member.title}
									fill
						...
						<div className="absolute -bottom-16 left-1/2 transform -translate-x-1/2 w-40 h-20 bg-linear-to-r from-blue-500/40 via-purple-500/40 to-pink-500/40 rounded-full blur-3xl opacity-0 group-hover:opacity-70 transition-all duration-500 pointer-events-none" />
					</div>
				</div>
			))}
		</div>
